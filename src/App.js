    ...
    render() {
        ...
        return (
            <>   <Navbar appName={this.state.appName}/>
                <Route  path="/heroList" render={props => <HeroList heroes={this.state.universeList[0].heroList}/>}/>

                <Route  path="/locationList" render={props => <LocationList locations={this.state.universeList[0].locationList}/>}/>

                <Route  path="/myBlank" render={props => <MyBlank universes={this.state.universeList}/>}/>

                <Route exact path="/" component={StartPage}/>

                <Route path="/createHero" render={props => <CreateHero {...props} addNewHero={this.addNewHero}/>}/>

                <Route path="/createLocation" render={props => <CreateLocation {...props} addNewLocation={this.addNewLocation}/>}/>

                <Route path="/createUniverse" render={props => <CreateUniverse {...props} addNewUniverse={this.addNewUniverse}/>} />
